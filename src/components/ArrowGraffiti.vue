  ...
  <div class="graffiti-arrow">
    ...
    >
      ...
      <path 
        ...
        d="M5,20 L70,20 L70,10 L95,25 L70,40 L70,30 L5,30 Z"
      />
      ...
      <g class="drips" :filter="`url(#${sprayPaintId})`">
        <path 
          :fill="`url(#${gradientId})`"
          d="M20,30 c0,0 -2,5 0,8 c2,-3 0,-8 0,-8"
        />
        <path 
          :fill="`url(#${gradientId})`"
          d="M40,30 c0,0 -1.5,4 0,6 c1.5,-2 0,-6 0,-6"
        />
        <path 
          :fill="`url(#${gradientId})`"
          d="M60,30 c0,0 -2,6 0,9 c2,-3 0,-9 0,-9"
        />
      </g>
    </svg>
  </div>
...
export default {
  ...
  setup() {
    ...
    const sprayPaintId = ref(`sprayPaint-${uniqueId.value}`);
    const gradientId = ref(`gradient-${uniqueId.value}`);
